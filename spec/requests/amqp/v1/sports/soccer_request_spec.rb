	...
	describe "POST requests from AMQP server" do
       ...
       # Bet Settlement 
        ...
        it 'should successfully cancel bets for an event' do
	        ...
	        payload = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><bet_cancel event_id='#{fixture.event_id}' product='1' start_time='#{fixture.created_at.to_i}' ><market name='Innings 1 to 5th top - {$competitor1} total' id='2' /></bet_cancel>"
        ...
        it 'should successfully rollback settlement for an event' do
        	...
        	auth_token = 'k/GV8prBUWE5D8JEreycbgT+'
        	url_1 = "http://localhost:3000/amqp/v1/sports/soccer"
	        payload_1 = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><bet_settlement certainty='2' product='3' event_id='#{fixture.event_id}' timestamp='#{fixture.scheduled_time.to_i}'><outcomes><market id='193'><outcome id='74' result='0'/><outcome id='76' result='1'/></market><market id='204' specifiers='setnr=1|total=9.5'><outcome id='12' result='0'/><outcome id='13' result='1'/></market><market id='201'><outcome id='863' result='0'/><outcome id='864' result='0'/><outcome id='861' result='1'/><outcome id='862' result='0'/></market></outcomes></bet_settlement>"
	        routing_key_1 = "hi.pre.-.bet_settlement.1.sr:match.#{fixture.event_id.delete("^0-9")}.-"
        	...
        	expect {
                ...
                http.read_timeout = 180
                request = Net::HTTP::Post.new(uri.request_uri)
                request.set_form_data('payload' => payload_1, 'routing_key' => routing_key_1)
                request['access-token'] = auth_token
                response = http.request(request)
                puts response.body
                puts response.code
        ...
        it 'should successfully rollback betcancel for an event' do
        	...
        	auth_token = 'k/GV8prBUWE5D8JEreycbgT+'
        	url_1 = "http://localhost:3000/amqp/v1/sports/soccer"
        	payload_1 = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><bet_cancel event_id='#{fixture.event_id}' product='1' start_time='#{fixture.created_at.to_i}' ><market name='Innings 1 to 5th top - {$competitor1} total' id='2' /></bet_cancel>"
	  		routing_key_1 = "hi.pre.-.bet_cancel.1.sr:match#{fixture.event_id.delete("^0-9")}.-"
	        ...
	        url = "http://localhost:3000/amqp/v1/sports/soccer"
	        payload = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><rollback_bet_cancel start_time='#{fixture.created_at.to_i}' end_time='#{fixture.created_at.to_i}' product='1' event_id='#{fixture.event_id}' ><market id='2' specifiers='total=4.5'/></rollback_bet_cancel>"
