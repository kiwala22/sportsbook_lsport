                ...
                <ul>
                  <li>
                    <div className="heads">
                      ...
                      These Terms and Conditions shall be valid for all betting account activity conducted with BetSports, a company duly incorporated and licensed under the laws of Uganda(License Number GB-69-056 ), hereafter referred to as the "Company".
                      </p>
                      <p className="paragraph">
                      ...
                      <span className="paragraph">
                          <ul className="lists">
                            ...
                            <li>
                              • Website or site means the Company.ug.
                            </li>
                            <li>
                      ...
                      <p className="paragraph">
                      The Terms can be changed at any time by the Company at its own discretion. All changes will become effective upon their publication on the site.
                      ...
                      <p className="paragraph">
                      All betting contracts, as well as any other legal relationship between the Client and the Company, for every circumstance not regulated by these Terms, is subject to Ugandan law.
                      </p>
                      <p className="paragraph">
                      The Courts of Uganda are agreed as the ultimate place of jurisdiction in the event of any dispute arising between the Client and the Company.
                      </p>
                      <h6>Bet Acceptance & Processing</h6>
                      <p className="paragraph">
                      Each Client must verify that bet details and the amount staked are correct before confirming a bet. Once confirmed, a bet cannot be changed or cancelled by the Client.
                      </p>
                      <p className="paragraph">
                      ...
                      <h6>Disputes</h6>
                      <p className="paragraph">Any dispute should immediately be reported to the company by email or telephone and the company shall use its best efforts to resolve any dispute with Clients.</p>
                      <p className="paragraph">In the event of any dispute the Client and the company agree that the records on the Company server logs shall act as the final arbiter in determining the outcome of any claim.</p>
                      <p className="paragraph">Clients dissatisfied with their treatment by the company have the option of making a complaint to the Company’s licensor, the National Gaming Board of Uganda.</p>
                      <h6>Errors</h6>
                      <p className="paragraph">Circumstances may arise where a bet is confirmed, or a payment is processed, in error.</p>
                      <p className="paragraph">The following is a non-exhaustive list of such circumstances:</p>
                      <span className="paragraph">
                        <ul className="lists">
                          <li>• When the prices offered by the Company are significantly dissimilar from those available in the general market;</li>
                          <li>• Where a bet containing dependent events is accidentally accepted, because of human or technical error;</li>
                          <li>• When a settling (resulting) error is made while computing or crediting the amount of winnings to a Client account;</li>
                          <li>• When a deposit or withdrawal is incorrectly recorded.</li>
                        </ul>
                      </span>
                      <p className="paragraph">In all such cases the Company reserves the right to correct all financial transactions, cancel accepted bets relating to the error or re-settling bets at the correct price that should have been available at the time the bet was placed.</p>
                      <h6>Intellectual Property</h6>
                      <p className="paragraph">Trademarks, domains, logos, images and any other material used by or in the Company’s services that can be found within its website are protected by copyright and may not be modified, reproduced or redistributed without the Company’s prior written permission.</p>
                      <p className="paragraph">You acknowledge and agree that the material and content contained within the websites is made available for your personal non-commercial use only. Any other use of such content is strictly prohibited. You agree not to assist or facilitate any third party to copy, reproduce, transmit, publish, display, distribute, commercially exploit, tamper with or create derivative works of such material and content.</p>
                      <h6>Legality of Site Use</h6>
                      <p className="paragraph">Use of the site may be illegal in certain countries including, for example, the USA.</p>
                      <p className="paragraph">Every Client is responsible for determining whether use of the site is compliant with applicable laws in the jurisdiction in which he is located at the time of usage.</p>
                      <p className="paragraph">The Company site does not constitute an offer, solicitation or invitation by the Company for the use of betting or other services in any countries where such activity is or may be illegal.</p>
                      <h6>Liabilities & Warranties</h6>
                      <p className="paragraph">
                      The Company does not warrant the constant availability and functionality of services and may not be held liable by the Client for any damages, losses, costs, loss of profits or any other disadvantage a Client may incur in connection with any disconnection from or the non-availability of any of the services offered by the Company.
                      </p>
                      <p className="paragraph">
                      ...
                      <h6>Privacy</h6>
                      <p className="paragraph">
                      In accordance with Lotteries And Gaming Regulations S. I No 7 (2017) of the National Gaming Board of Uganda, we are required to collect the following personal information from users:
                      </p>
                      <span className="paragraph">
                        <ul className="lists">
                          <li>• Name</li>
                          ...
                          <li>• Nationality</li>
                          <li>• Passport number for foreigners and refugee cards for refugees</li>
                        </ul>
                      </span>
                      <p className="paragraph">
                      We will take all reasonable steps to ensure that your information is kept secure and protected. All personal data is stored in the database of the company and will not be passed on to third parties except as required by Ugandan law.
                      </p>
                      <p className="paragraph">
                      ...
                      <span className="paragraph">
                        <ul className="lists">
                          ...
                          <li>• details of the transactions you carry out with us and details of your visits to the Website including, but not limited to, traffic data, location data, weblogs and other communication data.</li>
                        </ul>
                      </span>
                      <p className="paragraph">
                      ...
                      <span className="paragraph">
                        <ul className="lists">
                          ...
                          <li>• Setting up, operating and managing your account</li>
                          <li>• Complying with our legal and regulatory duties</li>
                          <li>• Carrying out customer research, surveys and analyses</li>
                          <li>• providing you with information about promotional offers and our products and services, where you have consented</li>
                          <li>• Monitoring transactions for the purposes of preventing fraud, irregular betting, money laundering and cheating.</li>
                        </ul>
                      </span>
                      <h6>Severability</h6>
                      <p className="paragraph">
                      ...
                      <p className="paragraph">
                      By registering on the website BetSports.ug and placing a bet, the Client confirms that he has reached the age of 25.
                      ...
                      <h6>Verification of Identity / AML (anti money laundering)</h6>
                      <p className="paragraph">
                      You warrant that the details you supply when opening or updating your account are correct and you are the rightful owner of the money which you at any time deposit in your account.
                      </p>
                      <p className="paragraph">
                      ...
                      <h6>Win Bouns</h6>
                      <p className="paragraph">
                      Your bonus percentage is determined by the number of matches completed. Therefore, any games in your multibet which are cancelled or postponed won’t count towards your total.
                      </p>
                      <p className="paragraph">
                      Your win bonus is calculated based on your winnings excluding the stake. So if you staked UGX 100 and won UGX 1,000, your winnings without the stake would be UGX 900. Therefore, a 50% win bonus would be UGX 450 and your total payout combining initial winnings and win bonus would be UGX 1,450.
                      </p>
                      <h6>Publicity</h6>
                      <p className="paragraph">
                      By playing any of our games on the website (Sports Betting, Jackpot, Casino) you agree that in case of winning a prize, you will allow your name and photo to be used for promotional purposes by the Company.
                      </p>
                    </div>
                  </li>
                </ul>
