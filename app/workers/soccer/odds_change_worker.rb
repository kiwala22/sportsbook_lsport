    ...
    def perform(payload)
        ...
        if fixture
            ...
            if message["odds_change"].has_key?("odds")
                if message["odds_change"]["odds"].has_key?("market") && message["odds_change"]["odds"].has_key?["market"].is_a?(Array)
                    message["odds_change"]["odds"]["market"].each do |market|
                        process_market(market, product, event_id)  
                    end
                end
                
                if message["odds_change"]["odds"].has_key?("market") && message["odds_change"]["odds"].has_key?["market"].is_a?(Hash)
