class VerifyController < ApplicationController
  ...
  def create
    ...
    render json: {message: "A PIN number has been sent to your phone"}, status: 200
  ...
  def update
    if Time.now > current_user.pin_sent_at.advance(minutes: 10)
      render json: {message: "Your pin has expired. Please request another." }, status: 422
      ...
      render json: {message: "Your phone number has been verified!"}, status: 200
    else
